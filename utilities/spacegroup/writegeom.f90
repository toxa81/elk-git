...
open(50,file="geometry.json",action="WRITE",form="FORMATTED",status="REPLACE")
write(50,'("{")')
write(50,'("  ""geometry"" : {")')
write(50,'("    ""avec"" : [")')
write(50,'("       [",G18.10,",",G18.10,",",G18.10,"],")')avec(:,1)
write(50,'("       [",G18.10,",",G18.10,",",G18.10,"],")')avec(:,2)
write(50,'("       [",G18.10,",",G18.10,",",G18.10,"]")')avec(:,3)
write(50,'("    ],")')
write(50,'("    ""species"" : [")')
do is=1,nspecies
  endl=","
  if (is.eq.nspecies) endl=" "
  write(50,'("      """,A,"""",A)')trim(spsymb(is)),endl
enddo  
write(50,'("    ],")')
write(50,'("    ""atoms"" : [")')
do is=1,nspecies
  do ia=1,natoms(is)
    endl=","
    if (is.eq.nspecies.and.ia.eq.natoms(is)) endl=" "
    write(50,'("      [""",A,""", [",G18.10,",",G18.10,",",G18.10,"], [0,0,0] ]",A)')&
      trim(spsymb(is)),atposl(:,ia,is),endl
  enddo
enddo
write(50,'("    ]")')
write(50,'("  }")')
